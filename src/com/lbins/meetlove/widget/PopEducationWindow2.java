 ...
 * Time: 20:58
 */
public class PopEducationWindow2 extends PopupWindow {
    private TextView  btn2, btn3, btn4, btn5, btn_cancel,btn1;
    private View mMenuView;

    public PopEducationWindow2(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_education2, null);
