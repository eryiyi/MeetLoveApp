 ...
 * Time: 20:58
 */
public class PopMarryWindow2 extends PopupWindow {
    private TextView btn1, btn2, btn3, btn_cancel,btn;
    private View mMenuView;

    public PopMarryWindow2(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_marry2, null);
        btn = (TextView) mMenuView.findViewById(R.id.btn);
