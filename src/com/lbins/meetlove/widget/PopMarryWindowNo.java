 ...
 * Time: 20:58
 */
public class PopMarryWindowNo extends PopupWindow {
    private TextView btn1, btn2, btn3, btn_cancel;
    private View mMenuView;

    public PopMarryWindowNo(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_marryno, null);
