 ...
 * Time: 20:58
 */
public class PopEducationWindowNo extends PopupWindow {
    private TextView  btn2, btn3, btn4, btn5, btn_cancel;
    private View mMenuView;

    public PopEducationWindowNo(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_education_no, null);
