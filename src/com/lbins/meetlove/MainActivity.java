...
public class MainActivity extends BaseActivity implements View.OnClickListener , Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String is_reply_login = "is_reply_login" + getGson().fromJson(getSp().getString("empid", ""), String.class);

        if("true".equals(getGson().fromJson(getSp().getString(is_reply_login, ""), String.class))){
            save(is_reply_login, "false");
            showReplyLoginDialog();
        }
    ...
    private void showReplyLoginDialog() {
        picAddDialog = new Dialog(MainActivity.this, R.style.dialog);
        View picAddInflate = View.inflate(this, R.layout.msg_reply_login_dialog, null);
...
//                    }
    ...
    public void registerBoradcastReceiver() {
        ...
        myIntentFilter.addAction("login_huanxin_out");
        //注册广播
    ...
    void  loginHx(){
        ...
        EMClient.getInstance().login(getGson().fromJson(getSp().getString("empid", ""), String.class), "123456", new EMCallBack() {
            @Override
            public void onSuccess() {
