...
//        MultiDex.install(this);
    ...
    public MeetLoveApplication() {
        ...
        txOptions = new DisplayImageOptions.Builder()//头像
                .showImageOnLoading(R.drawable.logo_bordered_256w)
                .showImageForEmptyUri(R.drawable.logo_bordered_256w)    // 设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.logo_bordered_256w)        // 设置图片加载或解码过程中发生错误显示的图片
                .cacheInMemory(true)                           // 设置下载的图片是否缓存在内存中
                .cacheOnDisc(true)                             // 设置下载的图片是否缓存在内存卡中
