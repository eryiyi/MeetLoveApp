...
public class AddReportActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empmobileStr = getIntent().getExtras().getString("empmobileStr");
        initView();
    }
    ...
    private void initView() {
        ...
        empmobile = (EditText) this.findViewById(R.id.empmobile);
        title.setText("投诉");
        ...
        if(!StringUtil.isNullOrEmpty(empmobileStr)){
            empmobile.setText(empmobileStr);
        }
    }
        ...
        switch (view.getId()){
            ...
            case R.id.btn_1:
            {
                ...
                if(StringUtil.isNullOrEmpty(nickname.getText().toString())){
                    showMsg(AddReportActivity.this, "请输入投诉对象姓名！");
                    return;
                } if(StringUtil.isNullOrEmpty(empmobile.getText().toString())){
                    showMsg(AddReportActivity.this, "请输入投诉对象电话！");
                    return;
                }
                if(empmobile.getText().toString().length() != 11){
                    showMsg(AddReportActivity.this, "请输入正确的投诉对象电话！");
                    return;
                }
    ...
    private void saveData() {
        StringRequest request = new StringRequest(
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("empmobile", empmobile.getText().toString());
                params.put("content", content.getText().toString());
                params.put("empid", getGson().fromJson(getSp().getString("empid", ""), String.class));
                if(!StringUtil.isNullOrEmpty(empid)){
                    params.put("empidBjbr", empid);
                }
                return params;
            }
