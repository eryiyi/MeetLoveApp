...
public class PhotosActivity extends BaseActivity implements View.OnClickListener,OnClickContentItemListener {
    ...
    private void initView() {
        ...
        if(empid.equals(getGson().fromJson(getSp().getString("empid", ""), String.class))){
            ...
            adapter = new ItemPhotosAdapter(lists, PhotosActivity.this, 1);
        }else{
            btn_right.setVisibility(View.GONE);
            adapter = new ItemPhotosAdapter(lists, PhotosActivity.this, 0);
        }
    ...
    private void deleteByIds(final String ids) {
        StringRequest request = new StringRequest(
                Request.Method.POST,
                InternetURL.appDeletePhotos,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
    ...
    public void registerBoradcastReceiver() {
        ...
        myIntentFilter.addAction("delete_photo_done");
        //注册广播
