                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code) == 200) {
                                    ...
                                    if(emp != null){
                                        if("1".equals(emp.getIs_use())){
                                            saveAccount(emp);
                                        }else if("2".equals(emp.getIs_use())){
                                            showMsg(LoginActivity.this, "请先维护个人资料");
                                            save("mobile", emp.getMobile());
                                            Intent intent = new Intent(LoginActivity.this, RegUpdateActivity.class);
                                            intent.putExtra("empid", emp.getEmpid());
                                            startActivity(intent);
                                        }else if("0".equals(emp.getIs_use())){
                                            showMsg(LoginActivity.this, "您的账户被禁用！");
                                        }
                                    }
