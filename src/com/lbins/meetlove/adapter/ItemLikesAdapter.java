    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (cell != null) {
            if("0".equals(cell.getIs_use())){
                ...
                holder.nickname.setTextColor(mContext.getResources().getColor(R.color.textColortwo));
            }else
            if("1".equals(cell.getIs_use())){
                //使用
                holder.nickname.setBackgroundResource(R.drawable.icon_hobby_normal);
                holder.nickname.setTextColor(mContext.getResources().getColor(R.color.textColor));
            }else{
                //被选中的 要变黄色
                holder.nickname.setBackgroundResource(R.drawable.icon_hobby_active);
                holder.nickname.setTextColor(mContext.getResources().getColor(R.color.white));
            }
