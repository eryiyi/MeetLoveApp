 ...
 */
public class ItemGroupMemberAdapter extends BaseAdapter {
     ...
     * 数据集合
     */
    private List<EmpGroups> datas = null;

    private String empid;//当前登陆者ID
    ...
    public ItemGroupMemberAdapter(Context context, List<EmpGroups> datas, String empid) {
        this.datas = datas;
        this.empid = empid;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        EmpGroups bean = datas.get(position);
...
//        }
     ...
     * 增加一项的时候
     */
    public void add(EmpGroups bean) {
    ...
    public List<EmpGroups> getDatas() {
        return datas;
    }
