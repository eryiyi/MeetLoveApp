...
//        });
    ...
    protected void onConnectionDisconnected() {
        ...
        if (NetUtils.hasNetwork(getActivity())){
            ...
            //发送通知 mainactivity 重新登录环信
//            Intent intent1 = new Intent("login_huanxin_out");
                                ...
                                if (code1 == 200) {
                                    ...
                                    if(data != null){
                                        ...
                                        if(listsIS != null && listsIS.size()>0){
                                            ...
                                            isFriends = 0;
                                            Toast.makeText(getActivity(), "双方不是好友，不能发消息！", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }else {
                                    Toast.makeText(getActivity(), jo.getString("message"), Toast.LENGTH_SHORT).show();
