            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(actionId == EditorInfo.IME_ACTION_SEARCH){
                    ...
                    if(!StringUtil.isNullOrEmpty(keywords.getText().toString())){
                        if(keywords.getText().toString().length() != 11){
...
//            likes.setText("");
    ...
    private PopEducationWindow2 popEducationWindow;
    private PopMarryWindow2 popMarryWindow;
    ...
    public void showPopMarry(){
        popMarryWindow = new PopMarryWindow2(getActivity(), itemsOnClickMarry);
        //显示窗口
    ...
    public void showPopEducation2(){
        popEducationWindow = new PopEducationWindow2(getActivity(), itemsOnClickEducation2);
        //显示窗口
        setBackgroundAlpha(0.5f);//设置屏幕透明度
